            ...
            if (isset($_SESSION['cart'][$i])) {
                foreach ($_SESSION['cart'][$i] as $key => $val) {
                    ...
                    if($tb_id_session!="") {
                        ...
                        mysqli_query($link, "insert into order_details (id,order_id,food_name, food_category, food_ingredients, food_original_price,food_veg_nonveg,food_image,food_qty) values(NULL,'$order_id','$food_name','$food_category','$food_ingredients','$food_original_price','$food_veg_nonveg','$food_image','$qty_total_session')") or die(mysqli_error($link));
