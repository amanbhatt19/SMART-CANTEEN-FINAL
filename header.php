				...
				<div class="auto-container clearfix">
					<div class="top-left">
						...
						<ul class="info-list">
							...
							<li><a href="mailto:smartcanteen@gmail.com" style="color: black"><span class="icon far fa-envelope"></span>
									smartcanteen@gmail.com</a></li>
						</ul>
					</div>
						...
						<div class="option-list">
							...
							<div class="cart-btn">
								<a href="view_cart.php" class="icon flaticon-shopping-cart" style="color: black"><span
										class="total-cart" style="background-color: #a40301;color:white"><?php echo load_cart_data2(); ?></span></a>
							</div>
							<!-- Search Btn -->
				...
				<div class="inner-container">
					<div class="auto-container clearfix">
						...
						<div class="logo-outer">
							<div class="logo" style="margin-top: -20px;"><a href="index.php"><img src="assets/images/logo-02.png" alt=""
										title=""></a></div>
						</div>
						...
						<div class="nav-outer clearfix">
							...
							<div class="outer-box">
								<div class="order">
									Order Now
									<span><a href="tel:1800-123-4567">+91 7926440532</a></span>
								</div>
							</div>
